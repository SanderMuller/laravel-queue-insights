...
<div role="radiogroup" aria-label="Clock format"
    ...
    <button type="button" role="radio" data-qi-clock-radio="12h"
            ...
            x-bind:class="clock === '12h' ? 'bg-gray-950/[0.08] text-gray-900 dark:bg-white/10 dark:text-gray-100' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100'"
            ...
            data-qi-tip="12-hour clock"
            data-qi-tip-detail="Times shown with AM / PM">
        12h
    </button>
    ...
    <button type="button" role="radio" data-qi-clock-radio="auto"
            ...
            x-bind:class="clock === 'auto' ? 'bg-gray-950/[0.08] text-gray-900 dark:bg-white/10 dark:text-gray-100' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100'"
            ...
            data-qi-tip="Auto"
            data-qi-tip-detail="Follow your browser locale"
            data-qi-tip-resolve="clock">
    ...
    <button type="button" role="radio" data-qi-clock-radio="24h"
            ...
            x-bind:class="clock === '24h' ? 'bg-gray-950/[0.08] text-gray-900 dark:bg-white/10 dark:text-gray-100' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100'"
            class="inline-flex h-7 items-center justify-center rounded-full px-2 text-[10px] font-semibold tracking-wide transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400"
            aria-label="24-hour clock"
            data-qi-tip="24-hour clock"
            data-qi-tip-detail="Times shown 00 – 23">
        24h
    </button>
</div>
