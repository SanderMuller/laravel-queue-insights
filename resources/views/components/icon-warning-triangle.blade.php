{{--
Inline warning-triangle icon. Solid triangle with `!` glyph + dot inside.
Used by failure / hung-run / payload-warning surfaces; pass class for
size + tone (defaults size-4 + currentColor).
--}}
