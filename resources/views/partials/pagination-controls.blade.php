    ...
    <div class="flex items-center gap-3">
        ...
        <label class="flex items-center gap-1.5 text-gray-500 dark:text-gray-300">
            ...
            <select wire:model.live.number="{{ $perPageModel }}"
                    class="rounded-md bg-white dark:bg-gray-900 px-1.5 py-0.5 font-medium text-gray-700 dark:text-gray-300 ring-1 ring-inset ring-gray-950/10 dark:ring-white/10 tabular-nums focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500">
