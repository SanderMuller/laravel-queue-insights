        ...
        @foreach($activeIssues as $issue)
            ...
            <li x-data="{ open: false }"
                @class([
                    ...
                    'bg-red-50 text-red-900 ring-red-600/20' => $isCritical,
                    'bg-amber-50 text-amber-900 ring-amber-600/20' => ! $isCritical,
                ])>
                <div class="flex items-start gap-3">
                    <span @class([
                        'mt-1 inline-block size-2.5 shrink-0 rounded-full',
                        'bg-red-600' => $isCritical,
                        'bg-amber-500' => ! $isCritical,
                    ...
                    <div class="flex min-w-0 flex-1 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3">
                        ...
                        <span @class([
                            ...
                            'bg-red-100 text-red-800 ring-red-600/20' => $isCritical,
                            'bg-amber-100 text-amber-800 ring-amber-600/20' => ! $isCritical,
                    ...
                    <button type="button"
                            ...
                            class="shrink-0 rounded p-0.5 hover:bg-gray-950/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
