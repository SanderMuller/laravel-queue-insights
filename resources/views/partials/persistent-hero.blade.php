...
<div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
    ...
    {{-- LC metric-card: 3-column sub-stats split by thin vertical rules. Each
         column gets hairline `border-l` (cols 2 & 3) with per-column padding
         (col 1 pr-4, col 2 px-4, col 3 pl-4) so the values read as discrete
    ...
    <dl aria-label="Headline stats" class="relative isolate overflow-hidden grid grid-cols-3 gap-y-4 rounded-xl bg-white p-5 ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
        ...
        <div class="border-l border-gray-950/5 px-4 dark:border-white/10">
        ...
        <div class="border-l border-gray-950/5 pl-4 dark:border-white/10">
