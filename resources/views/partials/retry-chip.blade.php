...
<x-queue-insights::hint
    triggerClass="shrink-0 inline-flex items-center gap-1 rounded-md bg-orange-50 dark:bg-orange-900/40 px-1.5 py-0.5 font-sans text-[10px] font-medium text-orange-700 dark:text-orange-300 ring-1 ring-inset ring-orange-600/20 dark:ring-orange-400/30 cursor-help">
