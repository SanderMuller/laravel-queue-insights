...
@if($snapshotCommandDead)
    <div role="alert" class="flex items-start gap-3 rounded-lg bg-red-100 p-3 text-sm text-red-900 ring-1 ring-inset ring-red-700/30 dark:bg-red-900/40 dark:text-red-200 dark:ring-red-400/30">
