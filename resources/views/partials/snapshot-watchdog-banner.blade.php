...
@if($snapshotCommandDead)
    <div role="alert" class="flex items-start gap-3 rounded-lg bg-red-100 p-3 text-sm text-red-900 ring-1 ring-inset ring-red-700/30">
        <svg class="mt-0.5 size-5 shrink-0 text-red-700" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div class="min-w-0 flex-1">
            ...
            <p class="mt-0.5 text-xs opacity-90">
                No <code class="rounded bg-red-200/60 px-1 py-0.5 font-mono text-[11px]">live:depth</code> keys are present for any configured queue —
                the <code class="rounded bg-red-200/60 px-1 py-0.5 font-mono text-[11px]">queue-insights:snapshot</code> command has been silent for at
