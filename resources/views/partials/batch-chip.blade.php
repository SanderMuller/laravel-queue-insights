...
<span class="relative inline-block" x-data="{ open: false }"
    ...
    <button type="button"
            ...
            class="inline-flex max-w-[18ch] items-center gap-1 rounded-md bg-indigo-50 dark:bg-indigo-900/40 px-1.5 py-0.5 font-mono text-[10px] font-medium text-indigo-700 dark:text-indigo-300 ring-1 ring-inset ring-indigo-600/20 dark:ring-indigo-400/30 hover:bg-indigo-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-500"
